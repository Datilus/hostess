...
class DataStatusResponse
{
     ...
     */
    public function __construct($is_error = true, $code_error, $meta_data = array(), $http_status_code = 400, $message,
                                $response = array())
    {
        ...
        die(json_encode(["error"   => $is_error, "code_error" => $code_error, "meta_data" => $meta_data,
                         "message" => $message, "response" => $response], JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT));
    }
